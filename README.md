...
> Landing page resmi E-Arsip UPT PT dan HMT Tuban. Mencakup hero section, fitur utama, statistik, dan form kontak, serta pratinjau dashboard penuh.
...
```bash
# Reset sistem dengan 5 data dummy per tabel
php artisan db:seed --class=FreshSeedData
```
...
> - Email: `admin@earsip.id` (atau `admin@gmail.com`)
> - Password: `admin123`
