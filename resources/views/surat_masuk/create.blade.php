        ...
        <div class="card border-0 shadow-sm" style="border-radius: 24px; max-width: 800px; width: 100%;">
            <div class="card-body p-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="fw-bold mb-1">Tambah Surat Masuk</h2>
                        <p class="text-muted small">Masukkan detail surat masuk baru ke dalam sistem</p>
                    </div>
                ...
                <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            id="perihal" name="perihal" value="{{ old('perihal') }}" placeholder="Masukkan perihal surat" required>
                        @error('perihal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                ...
                                id="pengirim" name="pengirim" value="{{ old('pengirim') }}" placeholder="Nama pengirim" required>
                            @error('pengirim')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                ...
                                id="penerima" name="penerima" value="{{ old('penerima') }}" placeholder="Nama penerima">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control rounded-xl py-3 px-4 bg-slate-50 border-slate-100" id="disposisi"
                            name="disposisi" rows="2" placeholder="Isi disposisi jika ada">{{ old('disposisi') }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            id="penerima_disposisi" name="penerima_disposisi" value="{{ old('penerima_disposisi') }}"
                            placeholder="Nama penerima disposisi">
                    </div>

                    <div class="mb-5">
                        <label for="file" class="form-label fw-bold text-slate-700">File Surat (PDF) <span
                                class="text-danger">*</span></label>
                        <input type="file"
