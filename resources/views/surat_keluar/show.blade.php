        ...
        <div class="mb-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('surat-keluar.edit', $suratKeluar->id) }}"
                    ...
                    @if($suratKeluar->file_path)
                        <a href="{{ asset('storage/' . $suratKeluar->file_path) }}"
                    ...
                    <div class="card border-0 shadow-sm" style="border-radius: 16px;">
                        ...
                        <div class="card-body p-4">
                            ...
                            @if(in_array(strtolower($extension), ['jpg', 'jpeg', 'png']))
                                <img src="{{ asset('storage/' . $suratKeluar->file_path) }}" class="img-fluid rounded"
                                    alt="Scan Surat">
                            @elseif(strtolower($extension) == 'pdf')
                                <iframe src="{{ asset('storage/' . $suratKeluar->file_path) }}" width="100%" height="600px"
                            ...
                            <div>
                                @php
                                    ...
                                    if ($suratKeluar->status == 'Terkirim')
                                        $statusClass = 'bg-terkirim';
                                    if ($suratKeluar->status == 'Selesai')
                                        $statusClass = 'bg-terarsip';
                                @endphp
                ...
                @if($suratKeluar->status == 'Draft')
                    <div class="card border-0 shadow-sm" style="border-radius: 16px; background: #f8fafc;">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted x-small mt-2 mb-0 text-center">Mengubah status surat menjadi "Terkirim" dan
                                mencatat tanggal kirim.</p>
                        </div>
                    </div>
                @endif
            </div>
