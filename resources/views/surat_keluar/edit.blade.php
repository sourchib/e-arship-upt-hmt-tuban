                ...
                <form action="{{ route('surat-keluar.update', $suratKeluar->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text"
                            ...
                            id="perihal" name="perihal" value="{{ old('perihal', $suratKeluar->perihal) }}" required>
                        @error('perihal')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="tujuan" class="form-label fw-bold text-slate-700">Tujuan <span
                                    class="text-danger">*</span></label>
                            <input type="text"
                                class="form-control rounded-xl py-3 px-4 bg-slate-50 border-slate-100 @error('tujuan') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            <label for="tanggal_surat" class="form-label fw-bold text-slate-700">Tanggal Surat <span
                                    class="text-danger">*</span></label>
                            <input type="date"
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <label for="prioritas" class="form-label fw-bold text-slate-700">Prioritas <span
                                    class="text-danger">*</span></label>
                            <select
                                class="form-select rounded-xl py-3 px-4 bg-slate-50 border-slate-100 @error('prioritas') is-invalid @enderror"
                        ...
                        <div class="col-md-6">
                            <label for="status" class="form-label fw-bold text-slate-700">Status <span
                                    class="text-danger">*</span></label>
                            <select
                                class="form-select rounded-xl py-3 px-4 bg-slate-50 border-slate-100 @error('status') is-invalid @enderror"
                                id="status" name="status" required>
                                <option value="Draft" {{ old('status', $suratKeluar->status) == 'Draft' ? 'selected' : '' }}>
                                    Draft</option>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 text-xs text-slate-400">
                            <i data-lucide="file-text" class="w-3 h-3 inline-block mr-1"></i> File saat ini: <a
                                href="{{ asset('storage/' . $suratKeluar->file_path) }}" target="_blank"
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control rounded-xl py-3 px-4 bg-slate-50 border-slate-100" id="keterangan"
                            name="keterangan" rows="3"
                            placeholder="Tambahkan catatan tambahan...">{{ old('keterangan', $suratKeluar->keterangan) }}</textarea>
                    </div>
                    ...
                    <div class="d-flex gap-3 pt-2">
                        ...
                        <a href="{{ route('surat-keluar.index') }}"
                            class="btn btn-cancel-modal py-3 fw-bold flex-grow-1 d-flex align-items-center justify-center"
