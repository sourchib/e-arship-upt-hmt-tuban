                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btns">
                            <a href="{{ route('arsip-pembibitan.show', $item->id) }}" class="action-btn action-btn-view" title="Detail">
                                <i data-lucide="eye"></i>
                            </a>
                            <a href="{{ route('arsip-pembibitan.edit', $item->id) }}" class="action-btn action-btn-edit" title="Edit">
...
<div class="mobile-card-list">
    ...
    <div class="mobile-card">
        ...
        <div class="mobile-card-footer mt-2">
            <div class="action-btns">
                <a href="{{ route('arsip-pembibitan.show', $item->id) }}" class="action-btn action-btn-view"><i data-lucide="eye"></i></a>
                <a href="{{ route('arsip-pembibitan.edit', $item->id) }}" class="action-btn action-btn-edit"><i data-lucide="edit-3"></i></a>
            </div>
